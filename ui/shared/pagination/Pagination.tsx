...
const Pagination = ({ page, onNextPageClick, onPrevPageClick, resetPage, hasPages, hasNextPage, canGoBackwards, isLoading, isVisible }: Props) => {
  ...
  return (
    <Flex
      className="lcai-pagination"
      fontSize="sm"
      alignItems="center"
    >
      <Skeleton isLoaded={ !showSkeleton } display="inline-block" mr={ 2 } borderRadius="base">
        <Button
          variant="outline"
          size="sm"
          onClick={ resetPage }
      ...
      <Skeleton isLoaded={ !showSkeleton } display="inline-block" ml={ 2 } borderRadius="base">
        <IconButton
          variant="outline"
