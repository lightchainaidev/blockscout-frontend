...
const LatestBlocks = () => {
  ...
  if (data) {
    ...
    content = (
      <>
        <VStack spacing={ 4 } mb={ 3 } overflow="hidden" alignItems="stretch">
  ...
  return (
    <div className="lcai-sidebar-wrapper">
      <Box width={{ base: '100%', lg: '280px' }} flexShrink={ 0 }>
        <div className="lcai-top-section-title">
          <Heading as="h4" size="sm">Latest blocks</Heading>
          { statsQueryResult.data?.network_utilization_percentage !== undefined && (
            <Skeleton isLoaded={ !statsQueryResult.isPlaceholderData } display="inline-block" className="subtitle">
              <Text as="span" fontSize="sm">
                Network utilization:{ nbsp }
              </Text>
              <Text as="span" fontSize="sm" fontWeight={ 700 } className="color-primary">
        ...
        <Box className="lcai-blocks-card-wrapper" mt={ 3 }>
          { content }
        </Box>
      </Box>
    </div>
