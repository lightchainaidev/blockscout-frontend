...
const TransactionPageContent = () => {
  ...
  const titleSecondRow = <div className="color-body"><TxSubHeading hash={ hash } hasTag={ Boolean(data?.transaction_tag) } txQuery={ txQuery }/></div>;
  ...
  return (
    <div className="lcai-transaction-details">
      <TextAd mb={ 6 }/>
      <PageTitle
